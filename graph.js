...
const question1 = document.getElementById('question1'); // cigarettes per day/vape pens per year
const question2 = document.getElementById('question2'); // how long smoking/vaping
const question3 = document.getElementById('question3'); // price per pack/vape pen
